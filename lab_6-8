...
# asks the user for five words using list comprehension, then creates a list named words using those words.
...
# checks if numbers on list are even or odd. if there isnt a set of all even or all odd it displays mixed.
